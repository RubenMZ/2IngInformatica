/*************************
Implementación del algoritmo de filtro (algoritmo de Peterson para N procesos)
en C, basado en el pseudocódigo mostrado en Wikipedia (http://en.wikipedia.org/wiki/Peterson%27s_algorithm)
**************************/
#include <stdio.h>
#include <stdlib.h>
#include <pthread.h>
