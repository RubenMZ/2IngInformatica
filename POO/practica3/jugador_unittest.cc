...
TEST(Jugador, ConstructorParametrosDefecto) {
  ...
  EXPECT_EQ("1", j.getCodigoJugador());
...
TEST(Jugador, ConstructorParametros) {
  ...
  EXPECT_EQ("2", j.getCodigoJugador());
...
TEST(Jugador, setCodigoygetCodigo) {
  ...
  EXPECT_EQ("1", j.getCodigoJugador());
  j.setCodigoJugador("55");
  EXPECT_EQ("55", j.getCodigoJugador());
}
...
TEST(Jugador, setApuestasygetApuestas) {
  ...
  i=l.begin();
  EXPECT_EQ(1, (*i).tipoApuesta);
  EXPECT_EQ("10", (*i).valorApuesta);
  EXPECT_EQ(15, (*i).cantApuesta);
  i++;
  EXPECT_EQ(2, (*i).tipoApuesta);
  EXPECT_EQ("rojo", (*i).valorApuesta);
  EXPECT_EQ(25, (*i).cantApuesta);
  i++;
  EXPECT_EQ(3, (*i).tipoApuesta);
  EXPECT_EQ("par", (*i).valorApuesta);
  EXPECT_EQ(35, (*i).cantApuesta);
  i++;
  EXPECT_EQ(4, (*i).tipoApuesta);
  EXPECT_EQ("bajo", (*i).valorApuesta);
  EXPECT_EQ(45, (*i).cantApuesta);
}
